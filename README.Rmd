...
```{r fig1, fig.width=10, fig.height=5, echo=FALSE, message=F}
plot_tree(tokens, token, lemma, upos, viewer_mode=F)
```
...
plot_tree(tokens, token, lemma, upos, annotation='clause', viewer_mode=F)
```
