...
If connected is TRUE, than whenever a token does not satisfy the lookup
...
because if multiword expressions are not directly connected in the tree,
they are part of different expressions.
